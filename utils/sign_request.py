...
from .utils import utf8, unicode_encoded_dict, to_unicode
...
class ClientSignRequestHandler(BaseSignRequestHandler):
    ...
    def get_auth_headers(self):
        headers = {
            ...
            'X-Api-Nonce': str(random.random()),
            'X-Api-Access-Key': str(self.access_key),
            'X-Api-Encrypt-Type': str(self.encrypt_type)
        }
        return headers
